...
CAG_EOLE_5250_EBM_TEST::CAG_EOLE_5250_EBM_TEST()
{
	resetVariableFlags();	
}
...
void CAG_EOLE_5250_EBM_TEST::generateHeader(CStringArray* pcsaHeader,
									   CStringArray* pcsaBody)
{
	...
	csViewOutStuff.Format( "'                  EXTRA! Basic 5250 Host Macro");
	pcsaHeader->Add(csViewOutStuff);
...
/****************************************************************************DC
	Function	:	CAG_EOLE_5250_EBM_TEST::appendBody()
...
*****************************************************************************/
void CAG_EOLE_5250_EBM_TEST::appendBody(int nFunctionNum,
...
void CAG_EOLE_5250_EBM_TEST::finalize(CStringArray* pcsaBody)
{
    pcsaBody->Add(" ");
	pcsaBody->Add("'********************************************************************");
...
void CAG_EOLE_5250_EBM_TEST::declareVariable(AG_VARIABLE agVariable,
										CStringArray* pcsaHeader,
										bool* bValue)
{
	CString csLocal;
...
void CAG_EOLE_5250_EBM_TEST::checkDebug(bool b_Debug,
...
void CAG_EOLE_5250_EBM_TEST::resetVariableFlags()
{
