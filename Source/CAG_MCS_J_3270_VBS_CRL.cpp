...
CAG_MCS_J_3270_VBS_CRL::CAG_MCS_J_3270_VBS_CRL()
{
	resetVariableFlags();	
}
...
void CAG_MCS_J_3270_VBS_CRL::generateHeader(CStringArray* pcsaHeader,
											 CStringArray* pcsaBody)
{
	...
	csViewOutStuff.Format( "'                 Attachmate MCS Presentation");
	pcsaHeader->Add(csViewOutStuff);

	csViewOutStuff.Format( "'             APIGen VBScript MCS Cached Run Local Script");
	pcsaHeader->Add(csViewOutStuff);
	...
	csViewOutStuff.Format( "  <title>Attachmate&#174; EXTRA! Java Viewer from API Generator</title>");
	pcsaHeader->Add(csViewOutStuff);
...
void CAG_MCS_J_3270_VBS_CRL::appendBody(int nFunctionNum,
...
void CAG_MCS_J_3270_VBS_CRL::finalize(CStringArray* pcsaBody)
{
	CString csViewOutStuff;
...
/****************************************************************************DC
	Function	:	CAG_MCS_J_3270_VBS_CRL::declareVariable()

	Purpose		:	Append variable declarations to the end of the header as 
					needed.

*****************************************************************************/
void CAG_MCS_J_3270_VBS_CRL::declareVariable(AG_VARIABLE agVariable,
											  CStringArray* pcsaHeader,
											  bool* bValue)
{
	CString csLocal;
...
void CAG_MCS_J_3270_VBS_CRL::checkDebug(bool b_Debug,
...
void CAG_MCS_J_3270_VBS_CRL::resetVariableFlags()
{
   b_pOIAObject = FALSE;
   b_nStatus = FALSE;
   b_nType = FALSE;
