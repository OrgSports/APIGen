...
CAG_MCS_Ax_3270_JS_DEPLOY::CAG_MCS_Ax_3270_JS_DEPLOY()
{
	resetVariableFlags();	
}
...
void CAG_MCS_Ax_3270_JS_DEPLOY::generateHeader(CStringArray* pcsaHeader,
											   CStringArray* pcsaBody)
{
	...
	csViewOutStuff.Format( "<script id=deployedViewer language=JavaScript>");
	pcsaHeader->Add(csViewOutStuff);
...
void CAG_MCS_Ax_3270_JS_DEPLOY::appendBody(int nFunctionNum,
...
void CAG_MCS_Ax_3270_JS_DEPLOY::finalize(CStringArray* pcsaBody)
{
	CString csViewOutStuff;
...
void CAG_MCS_Ax_3270_JS_DEPLOY::declareVariable(AG_VARIABLE agVariable,
												CStringArray* pcsaHeader,
												bool* bValue)
{
	CString csLocal;
	*bValue = TRUE;
	...
	switch ( agVariable )
	{
		...
		case AG_UTILBUFFER:
		{
			csLocal.Format( "var Buffer As String");
		}
		break;

		case AG_BSTR:
		{
			csLocal.Format( "var v As String");
		}
		break;
...
void CAG_MCS_Ax_3270_JS_DEPLOY::checkDebug(bool b_Debug,
...
void CAG_MCS_Ax_3270_JS_DEPLOY::collectDeploymentParameters(CStringArray* pcsaDeploymentParameters)
{
	
}

void CAG_MCS_Ax_3270_JS_DEPLOY::resetVariableFlags()
{
   b_nHRESULT = FALSE;
   b_nFLAG = FALSE;
   b_nATMFT = FALSE;
