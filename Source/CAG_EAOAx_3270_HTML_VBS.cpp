...
CAG_EAOAx_3270_HTML_VBS::CAG_EAOAx_3270_HTML_VBS()
{
	resetVariableFlags();	
}
...
void CAG_EAOAx_3270_HTML_VBS::generateHeader(CStringArray* pcsaHeader,
											 CStringArray* pcsaBody)
{
		...
		csViewOutStuff.Format( "'   Enterprise Access Objects ActiveX VBScript HTML Application");
		pcsaHeader->Add(csViewOutStuff);
...
void CAG_EAOAx_3270_HTML_VBS::appendBody(int nFunctionNum,
...
void CAG_EAOAx_3270_HTML_VBS::finalize(CStringArray* pcsaBody)
{
		CString csLocal;
...
void CAG_EAOAx_3270_HTML_VBS::declareVariable(AG_VARIABLE agVariable,
											  CStringArray* pcsaHeader,
											  bool* bValue)
{
	CString csLocal;
...
void CAG_EAOAx_3270_HTML_VBS::checkDebug(bool b_Debug,
...
void CAG_EAOAx_3270_HTML_VBS::resetVariableFlags()
{
   b_nHRESULT = FALSE;
   b_nFLAG = FALSE;
   b_nATMFT = FALSE;
