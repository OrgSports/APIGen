...
CAG_ROLE_5250_CPP::CAG_ROLE_5250_CPP()
{
	resetVariableFlags();	
}
...
void CAG_ROLE_5250_CPP::declareVariable(AG_VARIABLE agVariable,
...
void CAG_ROLE_5250_CPP::generateHeader(CStringArray* pcsaHeader,
									   CStringArray* pcsaBody)
{
	...
	csViewOutStuff.Format( "//                    Reflection For 5250 C++ Program");
	pcsaHeader->Add(csViewOutStuff);
...
void CAG_ROLE_5250_CPP::appendBody(int nFunctionNum,
...
void CAG_ROLE_5250_CPP::finalize(CStringArray* pcsaBody)
{
	CString csViewOutStuff;
...
void CAG_ROLE_5250_CPP::checkDebug(bool b_Debug,
...
void CAG_ROLE_5250_CPP::resetVariableFlags()
{
}
