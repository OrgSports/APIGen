...
CAG_MSI_CUSTOM_VBS::CAG_MSI_CUSTOM_VBS()
{
...
void CAG_MSI_CUSTOM_VBS::generateHeader(CStringArray* pcsaHeader,
										 CStringArray* pcsaBody)
{
	...
	pcsaHeader->Add("'               MSI VBScript Custom Action");
	pcsaHeader->Add("' ");
...
void CAG_MSI_CUSTOM_VBS::appendBody(int nFunctionNum,
...
void CAG_MSI_CUSTOM_VBS::finalize(CStringArray* pcsaBody)
{
	if ( b_csTaskID )
	{
...
void CAG_MSI_CUSTOM_VBS::declareVariable(AG_VARIABLE agVariable,
										  CStringArray* pcsaHeader,
										  bool* bValue)
{
	CString csLocal;
...
void CAG_MSI_CUSTOM_VBS::checkDebug( bool b_Debug, CString csFunctionName, CStringArray* pcsaBody )
{
	CString csLocal;
...
void CAG_MSI_CUSTOM_VBS::resetVariableFlags()
{
	b_csTaskID=FALSE;
	b_csBuffer=FALSE;
	b_nBufferSize=FALSE;
...
void CAG_MSI_CUSTOM_VBS::loadLanguageList(CListBox* listTranslateLanguage)
{
	int nPos = 0;
...
void CAG_MSI_CUSTOM_VBS::loadTerminalTypeList(CListBox* listTerminalTypes)
{
	int nPos = 0;
...
void CAG_MSI_CUSTOM_VBS::loadFunctionList(CListBox* listTranslateFunction)
{
