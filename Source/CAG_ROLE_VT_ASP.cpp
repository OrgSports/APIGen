...
CAG_ROLE_VT_ASP::CAG_ROLE_VT_ASP()
{
	resetVariableFlags();	
}
...
void CAG_ROLE_VT_ASP::declareVariable(AG_VARIABLE agVariable,
...
void CAG_ROLE_VT_ASP::generateHeader(CStringArray* pcsaHeader,
									 CStringArray* pcsaBody)
{
	...
	csViewOutStuff.Format( "//               Reflection For VT for Active Server Pages");
	pcsaHeader->Add(csViewOutStuff);
...
void CAG_ROLE_VT_ASP::appendBody(int nFunctionNum,
...
void CAG_ROLE_VT_ASP::finalize(CStringArray* pcsaBody)
{
	CString csViewOutStuff;
...
void CAG_ROLE_VT_ASP::checkDebug(bool b_Debug,
...
void CAG_ROLE_VT_ASP::resetVariableFlags()
{
}
