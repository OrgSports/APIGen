...
CAG_MCS_Ax_VT_VBS_DEPLOY::CAG_MCS_Ax_VT_VBS_DEPLOY()
{
	resetVariableFlags();	
}
...
void CAG_MCS_Ax_VT_VBS_DEPLOY::generateHeader(CStringArray* pcsaHeader,
...
void CAG_MCS_Ax_VT_VBS_DEPLOY::appendBody(int nFunctionNum,
...
void CAG_MCS_Ax_VT_VBS_DEPLOY::finalize(CStringArray* pcsaBody)
{
	CString csViewOutStuff;
...
void CAG_MCS_Ax_VT_VBS_DEPLOY::declareVariable(AG_VARIABLE agVariable,
												 CStringArray* pcsaHeader,
												 bool* bValue)
{
	CString csLocal;
...
void CAG_MCS_Ax_VT_VBS_DEPLOY::checkDebug(bool b_Debug,
...
void CAG_MCS_Ax_VT_VBS_DEPLOY::collectDeploymentParameters(CStringArray* pcsaDeploymentParameters)
{
	
}


void CAG_MCS_Ax_VT_VBS_DEPLOY::resetVariableFlags()
{
   b_pOIAObject = FALSE;
   b_nStatus = FALSE;
   b_nType = FALSE;
