...
CAG_MCS_Ax_VT_VBS_HTML::CAG_MCS_Ax_VT_VBS_HTML()
{
	resetVariableFlags();	
}
...
void CAG_MCS_Ax_VT_VBS_HTML::declareVariable(AG_VARIABLE agVariable,
...
void CAG_MCS_Ax_VT_VBS_HTML::generateHeader(CStringArray* pcsaHeader,
											 CStringArray* pcsaBody)
{
		...
		csViewOutStuff.Format( "//   MCS ActiveX Viewer JavaScript HTML Application");
		pcsaHeader->Add(csViewOutStuff);
		...
		csViewOutStuff.Format( "<title>Attachmate MCS ActiveX Viewer Using JavaScript</title>" );
		pcsaHeader->Add(csViewOutStuff);
...
void CAG_MCS_Ax_VT_VBS_HTML::appendBody(int nFunctionNum,
...
void CAG_MCS_Ax_VT_VBS_HTML::finalize(CStringArray* pcsaBody)
{
		CString csLocal;
		...
		csLocal.Format( "<object id=\"screen\" classid=\"clsid:EF390A69-2869-11d1-8AE5-0020AFF25CEE\"></object>" );
		pcsaBody->Add(csLocal);

		csLocal.Format( "<object id=\"con\" classid=\"clsid:49F6CD15-4039-11d1-AB61-00A0244EF170\"></object>" );
		pcsaBody->Add(csLocal);

		csLocal.Format( "<object id=\"status\" classid=\"clsid:61136565-4C8B-11D1-8B26-0020AFF25CEE\"></object>" );
		pcsaBody->Add(csLocal);
...
void CAG_MCS_Ax_VT_VBS_HTML::checkDebug(bool b_Debug,
...
void CAG_MCS_Ax_VT_VBS_HTML::resetVariableFlags()
{
   b_pOIAObject = FALSE;
   b_nStatus = FALSE;
   b_nType = FALSE;
