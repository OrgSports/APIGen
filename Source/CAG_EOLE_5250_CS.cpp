...
CAG_EOLE_5250_CS::CAG_EOLE_5250_CS()
{
	resetVariableFlags();	
}
...
void CAG_EOLE_5250_CS::generateHeader(CStringArray* pcsaHeader,
...
void CAG_EOLE_5250_CS::appendBody(int nFunctionNum,
...
void CAG_EOLE_5250_CS::finalize(CStringArray* pcsaBody)
{
	CString csLocal;
...
void CAG_EOLE_5250_CS::declareVariable(AG_VARIABLE agVariable,
									   CStringArray* pcsaHeader,
									   bool* bValue)
{
	CString csLocal;
...
void CAG_EOLE_5250_CS::checkDebug(bool b_Debug,
...
void CAG_EOLE_5250_CS::resetVariableFlags()
{
   b_SessionOpen = FALSE;
   b_nAttribute = FALSE;
   b_nStatus = FALSE;
