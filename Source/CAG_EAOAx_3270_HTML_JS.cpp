...
CAG_EAOAx_3270_HTML_JS::CAG_EAOAx_3270_HTML_JS()
{
	resetVariableFlags();	
}
...
void CAG_EAOAx_3270_HTML_JS::generateHeader(CStringArray* pcsaHeader,
											 CStringArray* pcsaBody)
{
		...
		csViewOutStuff.Format( "//  THIS IS ONLY PART WAY READY.  IT GENERATES SOME MCS JAVA STUFF THAT HASN'T BEEN REPLACED YET" );
		pcsaHeader->Add(csViewOutStuff);
...
void CAG_EAOAx_3270_HTML_JS::appendBody(int nFunctionNum,
...
void CAG_EAOAx_3270_HTML_JS::finalize(CStringArray* pcsaBody)
{
		CString csLocal;
...
void CAG_EAOAx_3270_HTML_JS::declareVariable(AG_VARIABLE agVariable,
											  CStringArray* pcsaHeader,
											  bool* bValue)
{
	CString csLocal;
...
void CAG_EAOAx_3270_HTML_JS::checkDebug(bool b_Debug,
...
void CAG_EAOAx_3270_HTML_JS::resetVariableFlags()
{
   b_nHRESULT = FALSE;
   b_nFLAG = FALSE;
   b_nATMFT = FALSE;
