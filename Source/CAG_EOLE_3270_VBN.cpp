...
CAG_EOLE_3270_VBN::CAG_EOLE_3270_VBN()
{
	resetVariableFlags();	
}
...
void CAG_EOLE_3270_VBN::generateHeader(CStringArray* pcsaHeader,
									  CStringArray* pcsaBody)
{
	...
	csViewOutStuff.Format( "//              OLE Automation Visual Basic .Net Application");
	pcsaHeader->Add(csViewOutStuff);
	...
	csViewOutStuff.Format( "//    in a Visual Basic .Net dialog application.  To use it, do the following:");
	pcsaHeader->Add(csViewOutStuff);

	csViewOutStuff.Format( "//   1. run the VB.Net New Application Wizard and specify that you want to create ");
	pcsaHeader->Add(csViewOutStuff);
...
void CAG_EOLE_3270_VBN::appendBody(int nFunctionNum,
...
void CAG_EOLE_3270_VBN::finalize(CStringArray* pcsaBody)
{
	CString csLocal;
...
void CAG_EOLE_3270_VBN::declareVariable(AG_VARIABLE agVariable,
									   CStringArray* pcsaHeader,
									   bool* bValue)
{
	CString csLocal;
...
void CAG_EOLE_3270_VBN::checkDebug(bool b_Debug,
...
void CAG_EOLE_3270_VBN::resetVariableFlags()
{
   b_SessionOpen = FALSE;
   b_nAttribute = FALSE;
   b_nStatus = FALSE;
