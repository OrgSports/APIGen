...
#ifndef __CAG_MSI_DBASE_CPP__
#define __CAG_MSI_DBASE_CPP__


// Include files
#include "CAG_ICONN.h"
class CAG_MSI_DBASE_CPP : public CAG_ICONN
{
...
};// END CLASS DEFINITION CAG_MSI_DBASE_CPP

#endif // __CAG_MSI_DBASE_CPP__
