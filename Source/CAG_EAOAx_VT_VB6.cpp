...
CAG_EAOAx_VT_VB6::CAG_EAOAx_VT_VB6()
{
	resetVariableFlags();	
}
...
void CAG_EAOAx_VT_VB6::generateHeader(CStringArray* pcsaHeader,
...
void CAG_EAOAx_VT_VB6::appendBody(int nFunctionNum,
...
void CAG_EAOAx_VT_VB6::finalize(CStringArray* pcsaBody)
{
	CString csViewOutStuff;
...
void CAG_EAOAx_VT_VB6::declareVariable(AG_VARIABLE agVariable,
										 CStringArray* pcsaHeader,
										 bool* bValue)
{
	CString csLocal;
...
void CAG_EAOAx_VT_VB6::checkDebug(bool b_Debug,
...
void CAG_EAOAx_VT_VB6::resetVariableFlags()
{
   b_nHRESULT = FALSE;
   b_nFLAG = FALSE;
   b_nATMFT = FALSE;
