...
void CAG_IHL_VB6::generateHeader(CStringArray* pcsaHeader,
								 CStringArray* pcsaBody)
{
	...
	CString csViewOutStuff;
	 ...
	 pcsaHeader->Add("'****************************************************************************");
    pcsaHeader->Add("'");
    pcsaHeader->Add("'  Attachmate APIGEN recorded IHLLAPI test program for Visual Basic 6.0");
    pcsaHeader->Add("'");
	...
	pcsaHeader->Add("'****************************************************************************");
	pcsaHeader->Add(" ");
    pcsaHeader->Add("Declare Sub WinHLLAPI Lib \"ihlapi32.dll\" (nFunc%, ByVal sDataStr$, nDatalen%, nRetCode%)");
    pcsaHeader->Add(" ");
    pcsaHeader->Add(" ");
...
void CAG_IHL_VB6::appendBody(int nFunctionNum,
...
void CAG_IHL_VB6::finalize(CStringArray* pcsaBody)
{
...
void CAG_IHL_VB6::declareVariable(AG_VARIABLE agVariable,
								  CStringArray* pcsaHeader,
								  bool* bValue)
{}

void CAG_IHL_VB6::checkDebug(bool b_Debug,
...
void CAG_IHL_VB6::resetVariableFlags()
{
