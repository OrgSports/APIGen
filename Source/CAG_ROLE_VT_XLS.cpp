...
CAG_ROLE_VT_XLS::CAG_ROLE_VT_XLS()
{
	resetVariableFlags();	
}
...
void CAG_ROLE_VT_XLS::declareVariable(AG_VARIABLE agVariable,
...
void CAG_ROLE_VT_XLS::generateHeader(CStringArray* pcsaHeader,
...
void CAG_ROLE_VT_XLS::appendBody(int nFunctionNum,
...
void CAG_ROLE_VT_XLS::finalize(CStringArray* pcsaBody)
{
	CString csViewOutStuff;
...
void CAG_ROLE_VT_XLS::checkDebug(bool b_Debug,
...
void CAG_ROLE_VT_XLS::resetVariableFlags()
{
}
