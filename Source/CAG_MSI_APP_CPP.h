...
#ifndef __CAG_MSI_APP_CPP__
#define __CAG_MSI_APP_CPP__


// Include files
#include "CAG_ICONN.h"
class CAG_MSI_APP_CPP : public CAG_ICONN
{
...
};// END CLASS DEFINITION CAG_MSI_APP_CPP

#endif // __CAG_MSI_APP_CPP__
