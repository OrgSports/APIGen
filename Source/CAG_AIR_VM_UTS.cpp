...
#include "CAG_AIR_VM_UTS.h"

void CAG_AIR_VM_UTS::loadFunctionList(CListBox* listTranslateFunction)
{
...
void CAG_AIR_VM_UTS::generateHeader(CStringArray* pcsaHeader,
								  CStringArray* pcsaBody)
{}

void CAG_AIR_VM_UTS::appendBody(int nFunctionNum,
...
void CAG_AIR_VM_UTS::finalize(CStringArray* pcsaBody)
{}

void CAG_AIR_VM_UTS::declareVariable(AG_VARIABLE agVariable,
								   CStringArray* pcsaHeader,
								   bool* bValue)
{
