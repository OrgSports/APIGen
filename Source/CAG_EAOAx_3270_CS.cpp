...
CAG_EAOAx_3270_CS::CAG_EAOAx_3270_CS()
{
	resetVariableFlags();	
}
...
void CAG_EAOAx_3270_CS::generateHeader(CStringArray* pcsaHeader,
...
void CAG_EAOAx_3270_CS::appendBody(int nFunctionNum,
...
void CAG_EAOAx_3270_CS::finalize(CStringArray* pcsaBody)
{
	CString csViewOutStuff;
...
void CAG_EAOAx_3270_CS::declareVariable(AG_VARIABLE agVariable,
										CStringArray* pcsaHeader,
										bool* bValue)
{
	CString csLocal;
...
void CAG_EAOAx_3270_CS::checkDebug(bool b_Debug,
...
void CAG_EAOAx_3270_CS::resetVariableFlags()
{
   b_nHRESULT = FALSE;
   b_nFLAG = FALSE;
   b_nATMFT = FALSE;
