...
/****************************************************************************DC
	Function	:	CAPIGenDlg::ShowEAOAxVTControls()

	Purpose		:	Show the controls for the EAO ActiveX function parameters.

*****************************************************************************/
void CAPIGenDlg::ShowEAOAxVTControls( int nFunction )
{
...
*****************************************************************************/
void CAPIGenDlg::LoadEAOAxVTArgumentArray( int* nFunctionPosition, BOOL bPromptForValues )
{
