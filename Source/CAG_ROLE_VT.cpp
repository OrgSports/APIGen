...
void CAG_ROLE_VT::loadLanguageList(CListBox* listTranslateLanguage)
{
...
void CAG_ROLE_VT::loadFunctionList(CListBox* listTranslateFunction)
{
	...
	csaFunctions.Add("GetCommandFile");
	...
	csaFunctions.Add("WaitForForSilence");
