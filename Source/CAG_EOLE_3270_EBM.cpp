...
CAG_EOLE_3270_EBM::CAG_EOLE_3270_EBM()
{
	resetVariableFlags();
}
...
void CAG_EOLE_3270_EBM::generateHeader(CStringArray* pcsaHeader,
...
/****************************************************************************DC
	Function	:	CAG_EOLE_3270_EBM::appendBody()
...
*****************************************************************************/
void CAG_EOLE_3270_EBM::appendBody(int nFunctionNum,
...
void CAG_EOLE_3270_EBM::finalize(CStringArray* pcsaBody)
{
	CString csLocal;
...
void CAG_EOLE_3270_EBM::declareVariable(AG_VARIABLE agVariable,
										CStringArray* pcsaHeader,
										bool* bValue)
{
	CString csLocal;
...
void CAG_EOLE_3270_EBM::checkDebug(bool b_Debug,
...
void CAG_EOLE_3270_EBM::resetVariableFlags()
{
