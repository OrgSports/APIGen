...
CAG_EOLE_VT_VB6::CAG_EOLE_VT_VB6()
{
	resetVariableFlags();	
}
...
void CAG_EOLE_VT_VB6::generateHeader(CStringArray* pcsaHeader,
									 CStringArray* pcsaBody)
{
	...
	csViewOutStuff.Format( "%s", "'         Visual Basic 6.0 VT Host OLE Automation");
	pcsaHeader->Add(csViewOutStuff);
...
/****************************************************************************DC
	Function	:	CAG_EOLE_VT_VB6::appendBody()
...
*****************************************************************************/
void CAG_EOLE_VT_VB6::appendBody(int nFunctionNum,
...
void CAG_EOLE_VT_VB6::finalize(CStringArray* pcsaBody)
{
	pcsaBody->Add("");	
...
void CAG_EOLE_VT_VB6::declareVariable(AG_VARIABLE agVariable,
									  CStringArray* pcsaHeader,
									  bool* bValue)
{
...
void CAG_EOLE_VT_VB6::checkDebug(bool b_Debug,
...
void CAG_EOLE_VT_VB6::resetVariableFlags()
{
