...
#include "CAG_EAOJ_5250_HTML_VBS.h"


CAG_EAOJ_5250_HTML_VBS::CAG_EAOJ_5250_HTML_VBS()
{
	resetVariableFlags();	
}
...
void CAG_EAOJ_5250_HTML_VBS::generateHeader(CStringArray* pcsaHeader,
										   CStringArray* pcsaBody)
{
	...
	csViewOutStuff.Format( "//              EAO for Java 5250 HTML VBScript Application");
	pcsaHeader->Add(csViewOutStuff);
...
void CAG_EAOJ_5250_HTML_VBS::appendBody(int nFunctionNum,
...
void CAG_EAOJ_5250_HTML_VBS::finalize(CStringArray* pcsaBody)
{
	CString csViewOutStuff;
...
void CAG_EAOJ_5250_HTML_VBS::declareVariable(AG_VARIABLE agVariable,
											CStringArray* pcsaHeader,
											bool* bValue)
{
	CString csLocal;
...
void CAG_EAOJ_5250_HTML_VBS::checkDebug(bool b_Debug,
...
void CAG_EAOJ_5250_HTML_VBS::resetVariableFlags()
{
   b_pOIAObject = FALSE;
   b_nStatus = FALSE;
   b_nType = FALSE;
