...
CAG_MCS_J_5250_VBS_CRL::CAG_MCS_J_5250_VBS_CRL()
{
	resetVariableFlags();	
}
...
/****************************************************************************DC
	Function	:	CAG_MCS_J_5250_VBS_CRL::declareVariable()

	Purpose		:	Append variable declarations to the end of the header as 
					needed.

*****************************************************************************/
void CAG_MCS_J_5250_VBS_CRL::declareVariable(AG_VARIABLE agVariable,
...
void CAG_MCS_J_5250_VBS_CRL::generateHeader(CStringArray* pcsaHeader,
...
void CAG_MCS_J_5250_VBS_CRL::appendBody(int nFunctionNum,
...
void CAG_MCS_J_5250_VBS_CRL::finalize(CStringArray* pcsaBody)
{
	CString csViewOutStuff;
...
void CAG_MCS_J_5250_VBS_CRL::checkDebug(bool b_Debug,
...
void CAG_MCS_J_5250_VBS_CRL::resetVariableFlags()
{
   b_pOIAObject = FALSE;
   b_nStatus = FALSE;
   b_nType = FALSE;
