...
CAG_ROLE_3270_WS::CAG_ROLE_3270_WS()
{
	resetVariableFlags();
}
...
void CAG_ROLE_3270_WS::generateHeader(CStringArray* pcsaHeader,
									  CStringArray* pcsaBody)
{
	...
	pcsaHeader->Add("' ****************************************************************************");
	pcsaHeader->Add("'                   Attachmate Reflection 3270");
	...
	pcsaBody->Add("" );
	pcsaBody->Add("Sessionname = inputbox(\"Open this Reflection 3270 session:\", \"Specify fully qualified Reflection session\", \"C:\\TEMP\\es9000.rsf\")");
...
void CAG_ROLE_3270_WS::appendBody(int nFunctionNum,
								  ...
								  CStringArray* pcsaBody)
{
	...
	switch ( nFunctionNum )
	{
		...
		case 218:	// TransmitTerminalKey
		{
			...
			csViewOutStuff.Format( "RIBMSession.TransmitTerminalKey cString" );
			pcsaBody->Add(csViewOutStuff);
...
void CAG_ROLE_3270_WS::finalize(CStringArray* pcsaBody)
{
	CString csViewOutStuff;
...
void CAG_ROLE_3270_WS::declareVariable(AG_VARIABLE agVariable,
									   CStringArray* pcsaHeader,
									   bool* bValue)
{
	CString csLocal;
...
void CAG_ROLE_3270_WS::checkDebug(bool b_Debug,
...
void CAG_ROLE_3270_WS::resetVariableFlags()
{
	b_Area=FALSE;
	b_bAttached=FALSE;
	b_bConnected=FALSE;
