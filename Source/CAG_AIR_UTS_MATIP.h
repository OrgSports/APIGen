...
#ifndef __CAG_AIR_UTS_MATIP__
#define __CAG_AIR_UTS_MATIP__


// Include files
#include "CAG_AIR.h"
class CAG_AIR_UTS_MATIP : public CAG_AIR
{
...
};// END CLASS DEFINITION CAG_AIR_UTS_MATIP

#endif // __CAG_AIR_UTS_MATIP__
