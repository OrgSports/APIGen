...
CAG_ROLE_VT_VBN::CAG_ROLE_VT_VBN()
{
	resetVariableFlags();	
}
...
void CAG_ROLE_VT_VBN::declareVariable(AG_VARIABLE agVariable,
...
void CAG_ROLE_VT_VBN::generateHeader(CStringArray* pcsaHeader,
									 CStringArray* pcsaBody)
{
	...
	csViewOutStuff.Format( "//               Reflection For VT VB.Net Program");
	pcsaHeader->Add(csViewOutStuff);
...
void CAG_ROLE_VT_VBN::appendBody(int nFunctionNum,
...
void CAG_ROLE_VT_VBN::finalize(CStringArray* pcsaBody)
{
	CString csViewOutStuff;
...
void CAG_ROLE_VT_VBN::checkDebug(bool b_Debug,
...
void CAG_ROLE_VT_VBN::resetVariableFlags()
{
}
