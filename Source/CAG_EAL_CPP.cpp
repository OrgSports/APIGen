...
void CAG_EAL_CPP::generateHeader(CStringArray* pcsaHeader,
								 CStringArray* pcsaBody)
{
	...
	csViewOutStuff.Format( "//               C++ EAL Application");
	pcsaHeader->Add(csViewOutStuff);
...
void CAG_EAL_CPP::appendBody(int nFunctionNum,
...
void CAG_EAL_CPP::finalize(CStringArray* pcsaBody)
{
	CString csLocal;
...
void CAG_EAL_CPP::declareVariable(AG_VARIABLE agVariable,
								  CStringArray* pcsaHeader,
								  bool* bValue)
{
...
void CAG_EAL_CPP::checkDebug(bool b_Debug,
...
void CAG_EAL_CPP::resetVariableFlags()
{
   b_nType = FALSE;
