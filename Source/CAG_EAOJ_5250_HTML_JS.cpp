...
#include "CAG_EAOJ_5250_HTML_JS.h"


CAG_EAOJ_5250_HTML_JS::CAG_EAOJ_5250_HTML_JS()
{
	resetVariableFlags();	
}
...
void CAG_EAOJ_5250_HTML_JS::generateHeader(CStringArray* pcsaHeader,
										   CStringArray* pcsaBody)
{
	...
	csViewOutStuff.Format( "//              EAO for Java 5250 HTML JavaScript Application");
	pcsaHeader->Add(csViewOutStuff);
...
void CAG_EAOJ_5250_HTML_JS::appendBody(int nFunctionNum,
...
void CAG_EAOJ_5250_HTML_JS::finalize(CStringArray* pcsaBody)
{
	CString csViewOutStuff;
...
void CAG_EAOJ_5250_HTML_JS::declareVariable(AG_VARIABLE agVariable,
											CStringArray* pcsaHeader,
											bool* bValue)
{
	CString csLocal;
...
void CAG_EAOJ_5250_HTML_JS::checkDebug(bool b_Debug,
...
void CAG_EAOJ_5250_HTML_JS::resetVariableFlags()
{
   b_pOIAObject = FALSE;
   b_nStatus = FALSE;
   b_nType = FALSE;
