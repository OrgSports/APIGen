...
CAG_EOLE_5250_CPP::CAG_EOLE_5250_CPP()
{
	resetVariableFlags();	
}
...
void CAG_EOLE_5250_CPP::generateHeader(CStringArray* pcsaHeader,
									   CStringArray* pcsaBody)
{
	...
	csViewOutStuff.Format( "//   Attachmate APIGen 5250 OLE Automation C++ Application");
	pcsaHeader->Add(csViewOutStuff);
...
void CAG_EOLE_5250_CPP::appendBody(int nFunctionNum,
...
void CAG_EOLE_5250_CPP::finalize(CStringArray* pcsaBody)
{
	CString csLocal;
...
void CAG_EOLE_5250_CPP::declareVariable(AG_VARIABLE agVariable,
										CStringArray* pcsaHeader,
										bool* bValue)
{
	CString csLocal;
...
void CAG_EOLE_5250_CPP::checkDebug(bool b_Debug,
...
void CAG_EOLE_5250_CPP::resetVariableFlags()
{
   b_SessionOpen = FALSE;
   b_nAttribute = FALSE;
   b_nStatus = FALSE;
