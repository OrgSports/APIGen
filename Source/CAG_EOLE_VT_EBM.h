...
#ifndef __CAG_EOLE_VT_EBM__
#define __CAG_EOLE_VT_EBM__


// Include files
#include "CAG_EOLE_VT.h"
class CAG_EOLE_VT_EBM : public CAG_EOLE_VT
{
...
};// END CLASS DEFINITION CAG_EOLE_VT_EBM

#endif // __CAG_EOLE_VT_EBM__
