...
CAG_ROLE_5250_XLS::CAG_ROLE_5250_XLS()
{
	resetVariableFlags();	
}
...
void CAG_ROLE_5250_XLS::declareVariable(AG_VARIABLE agVariable,
...
void CAG_ROLE_5250_XLS::generateHeader(CStringArray* pcsaHeader,
									   CStringArray* pcsaBody)
{
	...
	csViewOutStuff.Format( "//               Reflection For 5250 Excel Automation Script");
	pcsaHeader->Add(csViewOutStuff);
...
void CAG_ROLE_5250_XLS::appendBody(int nFunctionNum,
...
void CAG_ROLE_5250_XLS::finalize(CStringArray* pcsaBody)
{
	CString csViewOutStuff;
...
void CAG_ROLE_5250_XLS::checkDebug(bool b_Debug,
...
void CAG_ROLE_5250_XLS::resetVariableFlags()
{
}
