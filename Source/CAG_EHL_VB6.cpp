...
void CAG_EHL_VB6::declareVariable(CListBox* agVariable,
...
void CAG_EHL_VB6::checkDebug(bool b_Debug,
...
void CAG_EHL_VB6::resetVariableFlags()
{

}

void CAG_EHL_VB6::generateHeader(CStringArray* pcsaHeader,
								 CStringArray* pcsaBody)
{
    ...
    pcsaHeader->Add("'****************************************************************************");
    pcsaHeader->Add("'");
    pcsaHeader->Add("'  Attachmate APIGEN recorded EHLLAPI test program for Visual Basic 6.0");
    pcsaHeader->Add("'");
	...
	pcsaHeader->Add("'****************************************************************************");
	pcsaHeader->Add(" ");
    pcsaHeader->Add("Declare Sub HLLAPI Lib \"ehlapi32.dll\" (nFunc%, ByVal sDataStr$, nDatalen%, nRetCode%)");
    pcsaHeader->Add(" ");
    pcsaHeader->Add(" ");
...
void CAG_EHL_VB6::appendBody(int nFunctionNum,
...
void CAG_EHL_VB6::finalize(CStringArray* pcsaBody)
{
