...
CAG_MSI_DBASE_CPP::CAG_MSI_DBASE_CPP()
{
...
void CAG_MSI_DBASE_CPP::generateHeader(CStringArray* pcsaHeader,
...
void CAG_MSI_DBASE_CPP::appendBody(int nFunctionNum,
...
void CAG_MSI_DBASE_CPP::finalize(CStringArray* pcsaBody)
{
	if ( b_csTaskID )
	{
...
void CAG_MSI_DBASE_CPP::declareVariable(AG_VARIABLE agVariable,
										  CStringArray* pcsaHeader,
										  bool* bValue)
{
	CString csLocal;
...
void CAG_MSI_DBASE_CPP::checkDebug( bool b_Debug, CString csFunctionName, CStringArray* pcsaBody )
{
	CString csLocal;
...
void CAG_MSI_DBASE_CPP::resetVariableFlags()
{
	b_csTaskID=FALSE;
	b_csBuffer=FALSE;
	b_nBufferSize=FALSE;
...
void CAG_MSI_DBASE_CPP::loadLanguageList(CListBox* listTranslateLanguage)
{
	int nPos = 0;
...
void CAG_MSI_DBASE_CPP::loadTerminalTypeList(CListBox* listTerminalTypes)
{
	int nPos = 0;
...
void CAG_MSI_DBASE_CPP::loadFunctionList(CListBox* listTranslateFunction)
{
