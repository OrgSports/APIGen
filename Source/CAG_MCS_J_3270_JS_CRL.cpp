...
CAG_MCS_J_3270_JS_CRL::CAG_MCS_J_3270_JS_CRL()
{
	resetVariableFlags();	
}
...
void CAG_MCS_J_3270_JS_CRL::generateHeader(CStringArray* pcsaHeader,
										   CStringArray* pcsaBody)
{
	...
	csViewOutStuff.Format( "//                  Attachmate MCS 3270 Java Viewers");
	pcsaHeader->Add(csViewOutStuff);
...
void CAG_MCS_J_3270_JS_CRL::appendBody(int nFunctionNum,
...
void CAG_MCS_J_3270_JS_CRL::finalize(CStringArray* pcsaBody)
{
	CString csViewOutStuff;
...
/****************************************************************************DC
	Function	:	CAG_MCS_J_3270_JS_CRL::declareVariable()

	Purpose		:	Append variable declarations to the end of the header as 
					needed.

*****************************************************************************/
void CAG_MCS_J_3270_JS_CRL::declareVariable(AG_VARIABLE agVariable,
											CStringArray* pcsaHeader,
											bool* bValue)
{
	CString csLocal;
...
/* Added 101105 -- need to do some testing	//todo:
		case AG_XSTATUS_ARRAY:
		{
			csLocal.Format( "number XStatus[];" );
		}
		break;
*/
...
void CAG_MCS_J_3270_JS_CRL::checkDebug(bool b_Debug,
...
void CAG_MCS_J_3270_JS_CRL::resetVariableFlags()
{
   b_pOIAObject = FALSE;
   b_nStatus = FALSE;
   b_nType = FALSE;
