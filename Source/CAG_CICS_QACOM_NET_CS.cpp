...
CAG_CICS_QACOM_NET_CS::CAG_CICS_QACOM_NET_CS()
{
	resetVariableFlags();	
}
...
void CAG_CICS_QACOM_NET_CS::generateHeader(CStringArray* pcsaHeader,
											CStringArray* pcsaBody)
{
	...
	csViewOutStuff.Format( "//                    CICS Bridge C# .Net Program");
	pcsaHeader->Add(csViewOutStuff);
	...
	csViewOutStuff.Format( "//  QACom .Net API written in C#.  This header is to include information");
	pcsaHeader->Add(csViewOutStuff);
...
void CAG_CICS_QACOM_NET_CS::appendBody(int nFunctionNum,
...
void CAG_CICS_QACOM_NET_CS::finalize(CStringArray* pcsaBody)
{
	
}

void CAG_CICS_QACOM_NET_CS::declareVariable(AG_VARIABLE agVariable,
											 CStringArray* pcsaHeader,
											 bool* bValue)
{
...
void CAG_CICS_QACOM_NET_CS::checkDebug(bool b_Debug,
...
void CAG_CICS_QACOM_NET_CS::resetVariableFlags()
{
}