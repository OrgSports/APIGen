...
void CAG_VHI_CS::generateHeader(CStringArray* pcsaHeader,
									 CStringArray* pcsaBody)
{
	...
	pcsaHeader->Add("'                 APIGen C# 3270 Application");
	pcsaHeader->Add("'" );
	pcsaHeader->Add("'   This file consists of C# language calls to the Verastream");
	pcsaHeader->Add("'    Host Integrator 3270 OLE Automation interface.");
	pcsaHeader->Add("'" );
	pcsaHeader->Add("'   After this code is generated it will be necessary for you to build it");
	pcsaHeader->Add("'   in the Visual Studio .Net IDE and...");
	pcsaHeader->Add("'   1) ");
	pcsaHeader->Add("'      ");
	pcsaHeader->Add("'   2) ");
	pcsaHeader->Add("'      ");
...
void CAG_VHI_CS::appendBody(int nFunctionNum,
...
void CAG_VHI_CS::finalize(CStringArray* pcsaBody)
{
	pcsaBody->Add(" " );
}
...
void CAG_VHI_CS::declareVariable(AG_VARIABLE agVariable,
									  CStringArray* pcsaHeader,
									  bool* bValue)
{
	CString csLocal;
...
void CAG_VHI_CS::checkDebug(bool b_Debug,
...
void CAG_VHI_CS::resetVariableFlags()
{
