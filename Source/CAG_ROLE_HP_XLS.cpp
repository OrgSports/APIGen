...
CAG_ROLE_HP_XLS::CAG_ROLE_HP_XLS()
{
	resetVariableFlags();	
}
...
void CAG_ROLE_HP_XLS::declareVariable(AG_VARIABLE agVariable,
...
void CAG_ROLE_HP_XLS::generateHeader(CStringArray* pcsaHeader,
									   CStringArray* pcsaBody)
{
	...
	csViewOutStuff.Format( "//               Reflection For HP Excel Automation Script");
	pcsaHeader->Add(csViewOutStuff);
...
void CAG_ROLE_HP_XLS::appendBody(int nFunctionNum,
...
void CAG_ROLE_HP_XLS::finalize(CStringArray* pcsaBody)
{
	CString csViewOutStuff;
...
void CAG_ROLE_HP_XLS::checkDebug(bool b_Debug,
...
void CAG_ROLE_HP_XLS::resetVariableFlags()
{
}
