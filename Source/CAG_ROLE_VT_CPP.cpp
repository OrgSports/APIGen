...
CAG_ROLE_VT_CPP::CAG_ROLE_VT_CPP()
{
	resetVariableFlags();	
}
...
void CAG_ROLE_VT_CPP::declareVariable(AG_VARIABLE agVariable,
...
void CAG_ROLE_VT_CPP::generateHeader(CStringArray* pcsaHeader,
...
void CAG_ROLE_VT_CPP::appendBody(int nFunctionNum,
...
void CAG_ROLE_VT_CPP::finalize(CStringArray* pcsaBody)
{
	CString csViewOutStuff;
...
void CAG_ROLE_VT_CPP::checkDebug(bool b_Debug,
...
void CAG_ROLE_VT_CPP::resetVariableFlags()
{
}
