...
#ifndef __CAG_MSI_APP_VBS__
#define __CAG_MSI_APP_VBS__


// Include files
#include "CAG_ICONN.h"
class CAG_MSI_APP_VBS : public CAG_ICONN
{
...
};// END CLASS DEFINITION CAG_MSI_APP_VBS

#endif // __CAG_MSI_APP_VBS__
