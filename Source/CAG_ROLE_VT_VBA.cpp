...
CAG_ROLE_VT_VBA::CAG_ROLE_VT_VBA()
{
	resetVariableFlags();	
}
...
void CAG_ROLE_VT_VBA::declareVariable(AG_VARIABLE agVariable,
...
void CAG_ROLE_VT_VBA::generateHeader(CStringArray* pcsaHeader,
									 CStringArray* pcsaBody)
{
	...
	csViewOutStuff.Format( "//               Reflection For VT Visual Basic For Applications Script");
	pcsaHeader->Add(csViewOutStuff);
...
void CAG_ROLE_VT_VBA::appendBody(int nFunctionNum,
...
void CAG_ROLE_VT_VBA::finalize(CStringArray* pcsaBody)
{
	CString csViewOutStuff;
...
void CAG_ROLE_VT_VBA::checkDebug(bool b_Debug,
...
void CAG_ROLE_VT_VBA::resetVariableFlags()
{
}
