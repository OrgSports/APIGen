...
CAG_ROLE_VT_VB6::CAG_ROLE_VT_VB6()
{
	resetVariableFlags();	
}
...
void CAG_ROLE_VT_VB6::declareVariable(AG_VARIABLE agVariable,
...
void CAG_ROLE_VT_VB6::generateHeader(CStringArray* pcsaHeader,
									 CStringArray* pcsaBody)
{
	...
	csViewOutStuff.Format( "//               Reflection For VT Visual Basic 6.0 Program");
	pcsaHeader->Add(csViewOutStuff);
...
void CAG_ROLE_VT_VB6::appendBody(int nFunctionNum,
...
void CAG_ROLE_VT_VB6::finalize(CStringArray* pcsaBody)
{
	CString csViewOutStuff;
...
void CAG_ROLE_VT_VB6::checkDebug(bool b_Debug,
...
void CAG_ROLE_VT_VB6::resetVariableFlags()
{
}
