...
CAG_EAOAx_5250_VBN::CAG_EAOAx_5250_VBN()
{
	resetVariableFlags();	
}
...
void CAG_EAOAx_5250_VBN::generateHeader(CStringArray* pcsaHeader,
										CStringArray* pcsaBody)
{
	...
	csViewOutStuff.Format( "//               EAO for ActiveX 5250 VB.Net Application");
	pcsaHeader->Add(csViewOutStuff);
...
void CAG_EAOAx_5250_VBN::appendBody(int nFunctionNum,
...
void CAG_EAOAx_5250_VBN::finalize(CStringArray* pcsaBody)
{
	CString csViewOutStuff;
...
void CAG_EAOAx_5250_VBN::declareVariable(AG_VARIABLE agVariable,
										 CStringArray* pcsaHeader,
										 bool* bValue)
{
...
void CAG_EAOAx_5250_VBN::checkDebug(bool b_Debug,
...
void CAG_EAOAx_5250_VBN::resetVariableFlags()
{
   b_nHRESULT = FALSE;
   b_nFLAG = FALSE;
   b_nATMFT = FALSE;
