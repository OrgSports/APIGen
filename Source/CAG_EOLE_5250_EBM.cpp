...
CAG_EOLE_5250_EBM::CAG_EOLE_5250_EBM()
{
	resetVariableFlags();
}
...
void CAG_EOLE_5250_EBM::generateHeader(CStringArray* pcsaHeader,
...
/****************************************************************************DC
	Function	:	CAG_EOLE_5250_EBM::appendBody()
...
*****************************************************************************/
void CAG_EOLE_5250_EBM::appendBody(int nFunctionNum,
...
void CAG_EOLE_5250_EBM::finalize(CStringArray* pcsaBody)
{
	CString csLocal;
...
void CAG_EOLE_5250_EBM::declareVariable(AG_VARIABLE agVariable,
										CStringArray* pcsaHeader,
										bool* bValue)
{
	CString csLocal;
...
void CAG_EOLE_5250_EBM::checkDebug(bool b_Debug,
...
void CAG_EOLE_5250_EBM::resetVariableFlags()
{
