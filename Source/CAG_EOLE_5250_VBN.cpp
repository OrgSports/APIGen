...
CAG_EOLE_5250_VBN::CAG_EOLE_5250_VBN()
{
	resetVariableFlags();		
}
...
void CAG_EOLE_5250_VBN::generateHeader(CStringArray* pcsaHeader,
									   CStringArray* pcsaBody)
{
	...
	csViewOutStuff.Format( "%s", "'         Visual Basic .Net 5250 OLE Automation");
	pcsaHeader->Add(csViewOutStuff);

	csViewOutStuff.Format( "%s", "'" );
	pcsaHeader->Add(csViewOutStuff);

	csViewOutStuff.Format( "%s", "'   This file consists of a \"Main\" subroutine prepared for Visual Basic .Net");
	pcsaHeader->Add(csViewOutStuff);
...
/****************************************************************************DC
	Function	:	CAG_EOLE_5250_VBN::appendBody()
...
*****************************************************************************/
void CAG_EOLE_5250_VBN::appendBody(int nFunctionNum,
...
void CAG_EOLE_5250_VBN::finalize(CStringArray* pcsaBody)
{
	pcsaBody->Add("");	
...
void CAG_EOLE_5250_VBN::declareVariable(AG_VARIABLE agVariable,
										CStringArray* pcsaHeader,
										bool* bValue)
{
...
void CAG_EOLE_5250_VBN::checkDebug(bool b_Debug,
...
void CAG_EOLE_5250_VBN::resetVariableFlags()
{
