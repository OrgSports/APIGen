...
CAG_AIR_VM_UTS_J::CAG_AIR_VM_UTS_J()
{
	resetVariableFlags();
}
...
void CAG_AIR_VM_UTS_J::generateHeader(CStringArray* pcsaHeader,
									  CStringArray* pcsaBody)
{
	...
	pcsaHeader->Add("//");
	pcsaHeader->Add("//    To run the UTS Express Viewer session configured and automated in this file");
...
void CAG_AIR_VM_UTS_J::appendBody(int nFunctionNum,
...
void CAG_AIR_VM_UTS_J::finalize(CStringArray* pcsaBody)
{
	pcsaBody->Add("}");
	pcsaBody->Add("</script>");
	pcsaBody->Add("</BODY>");
...
/****************************************************************************DC
	Function	:	CAG_AIR_VM_UTS_J::declareVariable()

	Purpose		:	Append variable declarations to the end of the header as 
					needed.

*****************************************************************************/
void CAG_AIR_VM_UTS_J::declareVariable(AG_VARIABLE agVariable,
									   CStringArray* pcsaHeader,
									   bool* bValue)
{
	CString csLocal;
...
void CAG_AIR_VM_UTS_J::checkDebug(bool b_Debug,
								  CString csFunctionName,
								  CStringArray* pcsaBody)
{
	CString csLocal;
...
void CAG_AIR_VM_UTS_J::resetVariableFlags()
{
