...
#ifndef __CAG_EOLE_VT_CPP__
#define __CAG_EOLE_VT_CPP__


// Include files
#include "CAG_EOLE_VT.h"
class CAG_EOLE_VT_CPP : public CAG_EOLE_VT
{
...
};// END CLASS DEFINITION CAG_EOLE_VT_CPP

#endif // __CAG_EOLE_VT_CPP__
