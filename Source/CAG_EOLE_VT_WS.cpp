...
void CAG_EOLE_VT_WS::generateHeader(CStringArray* pcsaHeader,
...
/****************************************************************************DC
	Function	:	CAG_EOLE_VT_WS::appendBody()
...
*****************************************************************************/
void CAG_EOLE_VT_WS::appendBody(int nFunctionNum,
...
void CAG_EOLE_VT_WS::finalize(CStringArray* pcsaBody)
{
	pcsaBody->Add("");	
...
void CAG_EOLE_VT_WS::declareVariable(AG_VARIABLE agVariable,
										CStringArray* pcsaHeader,
										bool* bValue)
{
	CString csLocal;
...
void CAG_EOLE_VT_WS::checkDebug(bool b_Debug,
...
void CAG_EOLE_VT_WS::resetVariableFlags()
{
	b_cString=TRUE;
	b_Area=FALSE;
	b_bRet=TRUE;
