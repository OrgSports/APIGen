...
CAG_EAOAx_3270_CPP::CAG_EAOAx_3270_CPP()
{
	resetVariableFlags();	
}
...
void CAG_EAOAx_3270_CPP::generateHeader(CStringArray* pcsaHeader,
										CStringArray* pcsaBody)
{
	...
	csViewOutStuff.Format( "//               EAO for ActiveX 3270 C++ Application");
	pcsaHeader->Add(csViewOutStuff);
...
void CAG_EAOAx_3270_CPP::appendBody(int nFunctionNum,
...
void CAG_EAOAx_3270_CPP::finalize(CStringArray* pcsaBody)
{
	CString csViewOutStuff;
...
void CAG_EAOAx_3270_CPP::declareVariable(AG_VARIABLE agVariable,
										 CStringArray* pcsaHeader,
										 bool* bValue)
{
	CString csLocal;
...
void CAG_EAOAx_3270_CPP::checkDebug(bool b_Debug,
...
void CAG_EAOAx_3270_CPP::resetVariableFlags()
{
   b_nHRESULT = FALSE;
   b_nFLAG = FALSE;
   b_nATMFT = FALSE;
