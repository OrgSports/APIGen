...
CAG_MCS_Ax_3270_VBS_HDR::CAG_MCS_Ax_3270_VBS_HDR()
{
	resetVariableFlags();	
}
...
void CAG_MCS_Ax_3270_VBS_HDR::generateHeader(CStringArray* pcsaHeader,
											 CStringArray* pcsaBody)
{
	
}

void CAG_MCS_Ax_3270_VBS_HDR::appendBody(int nFunctionNum,
...
void CAG_MCS_Ax_3270_VBS_HDR::finalize(CStringArray* pcsaBody)
{
	
}

void CAG_MCS_Ax_3270_VBS_HDR::declareVariable(AG_VARIABLE agVariable,
											  CStringArray* pcsaHeader,
											  bool* bValue)
{
...
void CAG_MCS_Ax_3270_VBS_HDR::checkDebug(bool b_Debug,
...
void CAG_MCS_Ax_3270_VBS_HDR::resetVariableFlags()
{
   b_nHRESULT = FALSE;
   b_nFLAG = FALSE;
   b_nATMFT = FALSE;
