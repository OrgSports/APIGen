...
CAG_ROLE_5250_CS::CAG_ROLE_5250_CS()
{
	resetVariableFlags();	
}
...
void CAG_ROLE_5250_CS::declareVariable(AG_VARIABLE agVariable,
...
void CAG_ROLE_5250_CS::generateHeader(CStringArray* pcsaHeader,
...
void CAG_ROLE_5250_CS::appendBody(int nFunctionNum,
...
void CAG_ROLE_5250_CS::finalize(CStringArray* pcsaBody)
{
	CString csViewOutStuff;
...
void CAG_ROLE_5250_CS::checkDebug(bool b_Debug,
...
void CAG_ROLE_5250_CS::resetVariableFlags()
{
}
