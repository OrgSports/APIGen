...
CAG_MSI_DBASE_WS::CAG_MSI_DBASE_WS()
{
...
void CAG_MSI_DBASE_WS::generateHeader(CStringArray* pcsaHeader,
...
void CAG_MSI_DBASE_WS::appendBody(int nFunctionNum,
...
void CAG_MSI_DBASE_WS::finalize(CStringArray* pcsaBody)
{
	if ( b_csTaskID )
	{
...
void CAG_MSI_DBASE_WS::declareVariable(AG_VARIABLE agVariable,
										  CStringArray* pcsaHeader,
										  bool* bValue)
{
	CString csLocal;
...
void CAG_MSI_DBASE_WS::checkDebug( bool b_Debug, CString csFunctionName, CStringArray* pcsaBody )
{
	CString csLocal;
...
void CAG_MSI_DBASE_WS::resetVariableFlags()
{
	b_csTaskID=FALSE;
	b_csBuffer=FALSE;
	b_nBufferSize=FALSE;
...
void CAG_MSI_DBASE_WS::loadLanguageList(CListBox* listTranslateLanguage)
{
	int nPos = 0;
...
void CAG_MSI_DBASE_WS::loadTerminalTypeList(CListBox* listTerminalTypes)
{
	int nPos = 0;
...
void CAG_MSI_DBASE_WS::loadFunctionList(CListBox* listTranslateFunction)
{
