...
CAG_MCS_Ax_VT_JS_HTML::CAG_MCS_Ax_VT_JS_HTML()
{
	resetVariableFlags();	
}
...
void CAG_MCS_Ax_VT_JS_HTML::generateHeader(CStringArray* pcsaHeader,
...
void CAG_MCS_Ax_VT_JS_HTML::appendBody(int nFunctionNum,
...
void CAG_MCS_Ax_VT_JS_HTML::finalize(CStringArray* pcsaBody)
{
		CString csLocal;
...
void CAG_MCS_Ax_VT_JS_HTML::declareVariable(AG_VARIABLE agVariable,
											  CStringArray* pcsaHeader,
											  bool* bValue)
{
...
void CAG_MCS_Ax_VT_JS_HTML::checkDebug(bool b_Debug,
...
void CAG_MCS_Ax_VT_JS_HTML::resetVariableFlags()
{
   b_pOIAObject = FALSE;
   b_nStatus = FALSE;
   b_nType = FALSE;
