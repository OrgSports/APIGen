...
CAG_EAOAx_VT_CPP::CAG_EAOAx_VT_CPP()
{
	resetVariableFlags();	
}
...
void CAG_EAOAx_VT_CPP::generateHeader(CStringArray* pcsaHeader,
										CStringArray* pcsaBody)
{
	...
	csViewOutStuff.Format( "//               EAO for ActiveX VT C++ Application");
	pcsaHeader->Add(csViewOutStuff);
...
void CAG_EAOAx_VT_CPP::appendBody(int nFunctionNum,
...
void CAG_EAOAx_VT_CPP::finalize(CStringArray* pcsaBody)
{
	CString csViewOutStuff;
...
void CAG_EAOAx_VT_CPP::declareVariable(AG_VARIABLE agVariable,
										 CStringArray* pcsaHeader,
										 bool* bValue)
{
	CString csLocal;
...
void CAG_EAOAx_VT_CPP::checkDebug(bool b_Debug,
...
void CAG_EAOAx_VT_CPP::resetVariableFlags()
{
   b_nHRESULT = FALSE;
   b_nFLAG = FALSE;
   b_nATMFT = FALSE;
