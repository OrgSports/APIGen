...
CAG_EAOAx_5250_VB6::CAG_EAOAx_5250_VB6()
{
	resetVariableFlags();	
}
...
void CAG_EAOAx_5250_VB6::generateHeader(CStringArray* pcsaHeader,
										CStringArray* pcsaBody)
{
	...
	csViewOutStuff.Format( "//               EAO for ActiveX 5250 VB 6.0 Application");
	pcsaHeader->Add(csViewOutStuff);
...
void CAG_EAOAx_5250_VB6::appendBody(int nFunctionNum,
...
void CAG_EAOAx_5250_VB6::finalize(CStringArray* pcsaBody)
{
	CString csViewOutStuff;
...
void CAG_EAOAx_5250_VB6::declareVariable(AG_VARIABLE agVariable,
										 CStringArray* pcsaHeader,
										 bool* bValue)
{
...
void CAG_EAOAx_5250_VB6::checkDebug(bool b_Debug,
...
void CAG_EAOAx_5250_VB6::resetVariableFlags()
{
   b_nHRESULT = FALSE;
   b_nFLAG = FALSE;
   b_nATMFT = FALSE;
