...
CAG_ROLE_HP_ASP::CAG_ROLE_HP_ASP()
{
	resetVariableFlags();	
}
...
void CAG_ROLE_HP_ASP::declareVariable(AG_VARIABLE agVariable,
...
void CAG_ROLE_HP_ASP::generateHeader(CStringArray* pcsaHeader,
									   CStringArray* pcsaBody)
{
	...
	csViewOutStuff.Format( "//               Reflection For HP for Active Server Pages");
	pcsaHeader->Add(csViewOutStuff);
...
void CAG_ROLE_HP_ASP::appendBody(int nFunctionNum,
...
void CAG_ROLE_HP_ASP::finalize(CStringArray* pcsaBody)
{
	CString csViewOutStuff;
...
void CAG_ROLE_HP_ASP::checkDebug(bool b_Debug,
...
void CAG_ROLE_HP_ASP::resetVariableFlags()
{
}
