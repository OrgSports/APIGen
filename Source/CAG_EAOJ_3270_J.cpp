...
CAG_EAOJ_3270_J::CAG_EAOJ_3270_J()
{
	resetVariableFlags();	
}
...
void CAG_EAOJ_3270_J::generateHeader(CStringArray* pcsaHeader,
									 CStringArray* pcsaBody)
{
	...
	csViewOutStuff.Format( "//              EAO for Java 3270 Java Application");
	pcsaHeader->Add(csViewOutStuff);
...
void CAG_EAOJ_3270_J::appendBody(int nFunctionNum,
...
void CAG_EAOJ_3270_J::finalize(CStringArray* pcsaBody)
{
	CString csViewOutStuff;
...
*****************************************************************************/
void CAG_EAOJ_3270_J::declareVariable(AG_VARIABLE agVariable,
									  CStringArray* pcsaHeader,
									  bool* bValue)
{
	CString csLocal;
...
void CAG_EAOJ_3270_J::checkDebug( bool b_Debug, CString csFunctionName, CStringArray* pcsaBody )
{
	CString csLocal;
...
void CAG_EAOJ_3270_J::resetVariableFlags()
{
   b_pOIAObject = FALSE;
   b_nStatus = FALSE;
   b_nType = FALSE;
