...
CAG_ROLE_3270_VBN::CAG_ROLE_3270_VBN()
{
	resetVariableFlags();	
}
...
void CAG_ROLE_3270_VBN::declareVariable(AG_VARIABLE agVariable,
...
void CAG_ROLE_3270_VBN::generateHeader(CStringArray* pcsaHeader,
									   CStringArray* pcsaBody)
{
	...
	csViewOutStuff.Format( "//               Reflection For 3270 VB.Net Program");
	pcsaHeader->Add(csViewOutStuff);
...
void CAG_ROLE_3270_VBN::appendBody(int nFunctionNum,
...
void CAG_ROLE_3270_VBN::finalize(CStringArray* pcsaBody)
{
	CString csViewOutStuff;
...
void CAG_ROLE_3270_VBN::checkDebug(bool b_Debug,
...
void CAG_ROLE_3270_VBN::resetVariableFlags()
{
}
