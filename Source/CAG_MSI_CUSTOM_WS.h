...
#ifndef __CAG_MSI_CUSTOM_WS__
#define __CAG_MSI_CUSTOM_WS__


// Include files
#include "CAG_ICONN.h"
class CAG_MSI_CUSTOM_WS : public CAG_ICONN
{
...
};// END CLASS DEFINITION CAG_MSI_CUSTOM_WS

#endif // __CAG_MSI_CUSTOM_WS__
