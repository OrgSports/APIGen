...
CAG_EAOAx_5250_CS::CAG_EAOAx_5250_CS()
{
	resetVariableFlags();	
}
...
void CAG_EAOAx_5250_CS::generateHeader(CStringArray* pcsaHeader,
...
void CAG_EAOAx_5250_CS::appendBody(int nFunctionNum,
...
void CAG_EAOAx_5250_CS::finalize(CStringArray* pcsaBody)
{
	CString csViewOutStuff;
...
void CAG_EAOAx_5250_CS::declareVariable(AG_VARIABLE agVariable,
										CStringArray* pcsaHeader,
										bool* bValue)
{
...
void CAG_EAOAx_5250_CS::checkDebug(bool b_Debug,
...
void CAG_EAOAx_5250_CS::resetVariableFlags()
{
   b_nHRESULT = FALSE;
   b_nFLAG = FALSE;
   b_nATMFT = FALSE;
