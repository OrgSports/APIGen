...
void CAG_WHL_CPP::generateHeader(CStringArray* pcsaHeader,
...
void CAG_WHL_CPP::appendBody(int nFunctionNum,
...
void CAG_WHL_CPP::finalize(CStringArray* pcsaBody)
{
		CString csLocal;
...
void CAG_WHL_CPP::declareVariable(AG_VARIABLE agVariable,
								  CStringArray* pcsaHeader,
								  bool* bValue)
{
	CString csLocal;
...
void CAG_WHL_CPP::checkDebug(bool b_Debug,
...
void CAG_WHL_CPP::resetVariableFlags()
{
