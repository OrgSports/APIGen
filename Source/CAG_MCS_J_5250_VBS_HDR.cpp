...
CAG_MCS_J_5250_VBS_HDR::CAG_MCS_J_5250_VBS_HDR()
{
	resetVariableFlags();	
}
...
void CAG_MCS_J_5250_VBS_HDR::generateHeader(CStringArray* pcsaHeader,
...
void CAG_MCS_J_5250_VBS_HDR::appendBody(int nFunctionNum,
...
void CAG_MCS_J_5250_VBS_HDR::finalize(CStringArray* pcsaBody)
{
	CString csViewOutStuff;
...
/****************************************************************************DC
	Function	:	CAG_MCS_J_5250_VBS_HDR::declareVariable()

	Purpose		:	Append variable declarations to the end of the header as 
					needed.

*****************************************************************************/
void CAG_MCS_J_5250_VBS_HDR::declareVariable(AG_VARIABLE agVariable,
										   CStringArray* pcsaHeader,
										   bool* bValue)
{
	CString csLocal;
...
void CAG_MCS_J_5250_VBS_HDR::checkDebug(bool b_Debug,
...
void CAG_MCS_J_5250_VBS_HDR::resetVariableFlags()
{
   b_pOIAObject = FALSE;
   b_nStatus = FALSE;
   b_nType = FALSE;
