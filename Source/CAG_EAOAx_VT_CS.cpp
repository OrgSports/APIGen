...
CAG_EAOAx_VT_CS::CAG_EAOAx_VT_CS()
{
	resetVariableFlags();	
}
...
void CAG_EAOAx_VT_CS::generateHeader(CStringArray* pcsaHeader,
...
void CAG_EAOAx_VT_CS::appendBody(int nFunctionNum,
...
void CAG_EAOAx_VT_CS::finalize(CStringArray* pcsaBody)
{
	CString csViewOutStuff;
...
void CAG_EAOAx_VT_CS::declareVariable(AG_VARIABLE agVariable,
										CStringArray* pcsaHeader,
										bool* bValue)
{
	CString csLocal;
...
void CAG_EAOAx_VT_CS::checkDebug(bool b_Debug,
...
void CAG_EAOAx_VT_CS::resetVariableFlags()
{
   b_nHRESULT = FALSE;
   b_nFLAG = FALSE;
   b_nATMFT = FALSE;
