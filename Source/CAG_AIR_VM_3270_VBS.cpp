...
CAG_AIR_VM_3270_VBS::CAG_AIR_VM_3270_VBS()
{
	resetVariableFlags();
}
...
void CAG_AIR_VM_3270_VBS::generateHeader(CStringArray* pcsaHeader,
									  CStringArray* pcsaBody)
{
	...
	pcsaHeader->Add("' ****************************************************************************");
	pcsaHeader->Add("'                     Attachmate 3270 ViewMaster");
	...
	pcsaHeader->Add("'    need to have XXX installed and then simply double-click on this file.");
	...
	pcsaHeader->Add("Attachmate e-Vantage ViewMaster");
	pcsaHeader->Add("</TITLE>");
	pcsaHeader->Add("</HEAD>");
	pcsaHeader->Add("<BODY>");
	pcsaHeader->Add("<P>");
...
void CAG_AIR_VM_3270_VBS::appendBody(int nFunctionNum,
...
void CAG_AIR_VM_3270_VBS::finalize(CStringArray* pcsaBody)
{
...
/****************************************************************************DC
	Function	:	CAG_AIR_VM_3270_VBS::declareVariable()

	Purpose		:	Append variable declarations to the end of the header as 
					needed.

*****************************************************************************/
void CAG_AIR_VM_3270_VBS::declareVariable(AG_VARIABLE agVariable,
									   CStringArray* pcsaHeader,
									   bool* bValue)
{
	CString csLocal;
...
void CAG_AIR_VM_3270_VBS::checkDebug(bool b_Debug,
								  CString csFunctionName,
								  CStringArray* pcsaBody)
{
	CString csLocal;
...
void CAG_AIR_VM_3270_VBS::resetVariableFlags()
{
