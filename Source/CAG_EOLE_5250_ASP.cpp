...
CAG_EOLE_5250_ASP::CAG_EOLE_5250_ASP()
{
	resetVariableFlags();	
}
...
void CAG_EOLE_5250_ASP::generateHeader(CStringArray* pcsaHeader,
...
void CAG_EOLE_5250_ASP::appendBody(int nFunctionNum,
...
void CAG_EOLE_5250_ASP::finalize(CStringArray* pcsaBody)
{
	CString csLocal;
...
void CAG_EOLE_5250_ASP::declareVariable(AG_VARIABLE agVariable,
										CStringArray* pcsaHeader,
										bool* bValue)
{
	CString csLocal;
...
void CAG_EOLE_5250_ASP::checkDebug(bool b_Debug,
...
void CAG_EOLE_5250_ASP::resetVariableFlags()
{
   b_SessionOpen = FALSE;
   b_nAttribute = FALSE;
   b_nStatus = FALSE;
