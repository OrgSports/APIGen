...
void CAG_ROLE_VT_WS::generateHeader(CStringArray* pcsaHeader,
									  CStringArray* pcsaBody)
{
	...
	pcsaHeader->Add("' ****************************************************************************");
	pcsaHeader->Add("'                   Attachmate Reflection VT");
	...
	pcsaBody->Add("" );
	pcsaBody->Add("set Session = CreateObject(\"ReflectionIBM.Session\")" );
	pcsaBody->Add("" );
	pcsaBody->Add("Sessionname = inputbox(\"Open this Reflection VT session:\", \"Specify fully qualified Reflection session\", \"C:\\TEMP\\auburn.rsf\")");
...
void CAG_ROLE_VT_WS::appendBody(int nFunctionNum,
								  ...
								  CStringArray* pcsaBody)
{
	...
	switch ( nFunctionNum )
	{
		...
		{
			csViewOutStuff.Format( "Session.AbortTransfer" );
			pcsaBody->Add(csViewOutStuff);
		}
		break;
		...
		{
			csViewOutStuff.Format( "Session.AboutReflectionDlg" );
			pcsaBody->Add(csViewOutStuff);
		}
		break;
		...
		{
			csViewOutStuff.Format( "Session.ActivateCommandLine" );
			pcsaBody->Add(csViewOutStuff);
		}
		break;
		...
		case 3:		// AddHotListItem
		{
			...
			csViewOutStuff.Format( "Session.AddHotListItem cString, csName, csCommand, nOptions" );
			pcsaBody->Add(csViewOutStuff);
		...
		case 4:		// AddReference
		{
			...
			csViewOutStuff.Format( "Session.AddReference cString" );
			pcsaBody->Add(csViewOutStuff);
		...
		{
			csViewOutStuff.Format( "Session.AddReferenceDlg" );
			pcsaBody->Add(csViewOutStuff);
		}
		break;
		...
		{
			csViewOutStuff.Format( "Session.AppendSelection" );
			pcsaBody->Add(csViewOutStuff);
		}
		break;
		...
		case 7:		// AppendSQLStatement
		{
			...
			csViewOutStuff.Format( "Session.AppendSQLStatement nType, csCommand" );
			pcsaBody->Add(csViewOutStuff);
		...
		{
			csViewOutStuff.Format( "Session.CancelSelection" );
			pcsaBody->Add(csViewOutStuff);
		}
		break;
		...
		{
			csViewOutStuff.Format( "Session.CancelTransfer" );
			pcsaBody->Add(csViewOutStuff);
		}
		break;
		...
		{
			csViewOutStuff.Format( "Session.CheckEvent" );
			pcsaBody->Add(csViewOutStuff);
		}
		break;
		...
		case 11:	// CheckEventNumber
		{
			...
			csViewOutStuff.Format( "Session.CheckEventNumber nEventNum" );
			pcsaBody->Add(csViewOutStuff);
		...
		case 12:	// ClearEvents
		{
			csViewOutStuff.Format( "Session.ClearEvents" );
			pcsaBody->Add(csViewOutStuff);
		}
		break;
		...
		{
			csViewOutStuff.Format( "Session.ClearHotlists" );
			pcsaBody->Add(csViewOutStuff);
		}
		break;
		...
		{
			csViewOutStuff.Format( "Session.ClearHotspots" );
			pcsaBody->Add(csViewOutStuff);
		}
		break;
		...
		{
			csViewOutStuff.Format( "Session.ClearIBMPrinterFonts" );
			pcsaBody->Add(csViewOutStuff);
		}
		break;
		...
		case 16:	// ClearMenu
		{
			csViewOutStuff.Format( "Session.ClearMenu" );
			pcsaBody->Add(csViewOutStuff);
		}
		break;
		...
		{
			csViewOutStuff.Format( "Session.ClearNWSAA3270Config" );
			pcsaBody->Add(csViewOutStuff);
		}
		break;
		...
		{
			csViewOutStuff.Format( "Session.ClearSelection" );
			pcsaBody->Add(csViewOutStuff);
		}
		break;
		...
		{
			csViewOutStuff.Format( "Session.ClosePrinter" );
			pcsaBody->Add(csViewOutStuff);
		}
		break;
		...
		case 21:	// CompileScript
		{
			...
			csViewOutStuff.Format( "Session.CompileScript cString" );
			pcsaBody->Add(csViewOutStuff);
		...
		{
			csViewOutStuff.Format( "Session.CopyPasteSettingsDialog" );
			pcsaBody->Add(csViewOutStuff);
		}
		break;
		...
		{
			csViewOutStuff.Format( "Session.CopySelection" );
			pcsaBody->Add(csViewOutStuff);
		}
		break;
		...
		case 25:	// CopyTable
		{
			csViewOutStuff.Format( "Session.CopyTable" );
			pcsaBody->Add(csViewOutStuff);
		}
		break;
		...
		{
			csViewOutStuff.Format( "Session.CutSelection" );
			pcsaBody->Add(csViewOutStuff);
		}
		break;
		...
		case 27:	// DDESetupDlg
		{
			csViewOutStuff.Format( "Session.DDESetupDlg" );
			pcsaBody->Add(csViewOutStuff);
		}
		break;
		...
		case 28:	// DefineEvent
		{
			...
			csViewOutStuff.Format( "Session.DefineEvent nEventNum, nType, cString, nRow, nColumn, nKey" );
			pcsaBody->Add(csViewOutStuff);
		...
		case 224:	// WaitForDisplayString
		{
			...
			pcsaBody->Add("Session.WaitForDisplayString cString, nRow, nColumn, nTimeout " );
...
void CAG_ROLE_VT_WS::finalize(CStringArray* pcsaBody)
{
	CString csViewOutStuff;
...
void CAG_ROLE_VT_WS::declareVariable(AG_VARIABLE agVariable,
									   CStringArray* pcsaHeader,
									   bool* bValue)
{
	CString csLocal;
...
void CAG_ROLE_VT_WS::checkDebug(bool b_Debug,
...
void CAG_ROLE_VT_WS::resetVariableFlags()
{
	b_Area=FALSE;
	b_bAttached=FALSE;
	b_bConnected=FALSE;
