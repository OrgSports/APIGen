...
CAG_EOLE_3270_ASP::CAG_EOLE_3270_ASP()
{
	resetVariableFlags();	
}
...
void CAG_EOLE_3270_ASP::generateHeader(CStringArray* pcsaHeader,
									   CStringArray* pcsaBody)
{
	...
	csViewOutStuff.Format( "//   Attachmate APIGen OLE Automation C++ Application");
	pcsaHeader->Add(csViewOutStuff);
...
void CAG_EOLE_3270_ASP::appendBody(int nFunctionNum,
...
void CAG_EOLE_3270_ASP::finalize(CStringArray* pcsaBody)
{
	CString csLocal;
...
void CAG_EOLE_3270_ASP::declareVariable(AG_VARIABLE agVariable,
										CStringArray* pcsaHeader,
										bool* bValue)
{
	CString csLocal;
...
void CAG_EOLE_3270_ASP::checkDebug(bool b_Debug,
...
void CAG_EOLE_3270_ASP::resetVariableFlags()
{
   b_SessionOpen = FALSE;
   b_nAttribute = FALSE;
   b_nStatus = FALSE;
