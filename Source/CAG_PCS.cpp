...
void CAG_PCS::loadFunctionList(CListBox* listTranslateFunction)
{
	...
	csaFunctions.Add( "105 Change Switch List" );
	csaFunctions.Add( "106 Change Presentation Space Name" );
	csaFunctions.Add( "107 Query Handle" );

	csaFunctions.Add( "110 Start Playing Macro" );
...
void CAG_PCS::loadLanguageList(CListBox* listTranslateLanguage)
{
	listTranslateLanguage->ResetContent();
	listTranslateLanguage->InsertString( 0, "C++" );
	listTranslateLanguage->InsertString( 1, "VB 6.0" );
	
	listTranslateLanguage->SetCurSel(0);
}

void CAG_PCS::loadTerminalTypeList(CListBox* listTerminalTypes)
{
