...
void CAG_ROLE_HP_CS::declareVariable(AG_VARIABLE agVariable,
...
void CAG_ROLE_HP_CS::generateHeader(CStringArray* pcsaHeader,
...
void CAG_ROLE_HP_CS::appendBody(int nFunctionNum,
...
void CAG_ROLE_HP_CS::finalize(CStringArray* pcsaBody)
{
	CString csViewOutStuff;
...
void CAG_ROLE_HP_CS::checkDebug(bool b_Debug,
...
void CAG_ROLE_HP_CS::resetVariableFlags()
{
}
