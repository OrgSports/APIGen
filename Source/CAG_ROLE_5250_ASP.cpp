...
CAG_ROLE_5250_ASP::CAG_ROLE_5250_ASP()
{
	resetVariableFlags();	
}
...
void CAG_ROLE_5250_ASP::declareVariable(AG_VARIABLE agVariable,
...
void CAG_ROLE_5250_ASP::generateHeader(CStringArray* pcsaHeader,
									   CStringArray* pcsaBody)
{
	...
	csViewOutStuff.Format( "//               Reflection For 5250 for Active Server Pages");
	pcsaHeader->Add(csViewOutStuff);
...
void CAG_ROLE_5250_ASP::appendBody(int nFunctionNum,
...
void CAG_ROLE_5250_ASP::finalize(CStringArray* pcsaBody)
{
	CString csViewOutStuff;
...
void CAG_ROLE_5250_ASP::checkDebug(bool b_Debug,
...
void CAG_ROLE_5250_ASP::resetVariableFlags()
{
}
