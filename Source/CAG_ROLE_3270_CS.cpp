...
CAG_ROLE_3270_CS::CAG_ROLE_3270_CS()
{
	resetVariableFlags();	
}
...
void CAG_ROLE_3270_CS::declareVariable(AG_VARIABLE agVariable,
...
void CAG_ROLE_3270_CS::generateHeader(CStringArray* pcsaHeader,
...
void CAG_ROLE_3270_CS::appendBody(int nFunctionNum,
...
void CAG_ROLE_3270_CS::finalize(CStringArray* pcsaBody)
{
	CString csViewOutStuff;
...
void CAG_ROLE_3270_CS::checkDebug(bool b_Debug,
...
void CAG_ROLE_3270_CS::resetVariableFlags()
{
}
