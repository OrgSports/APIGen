...
void CAG_RWEB_VT_JS::generateHeader(CStringArray* pcsaHeader,
									  CStringArray* pcsaBody)
{
	...
	pcsaHeader->Add("//                 APIGen VT Terminal JavaScript Program");
	pcsaHeader->Add("// ");
	pcsaHeader->Add("//  This file is a program that features the use of the Reflection RWeb");
	pcsaHeader->Add("//  API written in JavaScript.  This header is to include information");
    ...
    pcsaHeader->Add( "var uname;");
    pcsaHeader->Add( "var pword;");
    pcsaHeader->Add( "var count = 0;");
    pcsaHeader->Add( "var errcount = 0;");
    pcsaHeader->Add( "var inited = 0;");
	...
	pcsaHeader->Add("function doConnect()");
	pcsaHeader->Add("{");
...
void CAG_RWEB_VT_JS::appendBody(int nFunctionNum,
...
void CAG_RWEB_VT_JS::finalize(CStringArray* pcsaBody)
{
	CString csViewOutStuff;
...
void CAG_RWEB_VT_JS::declareVariable(AG_VARIABLE agVariable,
									   CStringArray* pcsaHeader,
									   bool* bValue)
{
	CString csLocal;
...
void CAG_RWEB_VT_JS::checkDebug(bool b_Debug,
...
void CAG_RWEB_VT_JS::resetVariableFlags()
{
	b_ECLFieldObj=0;
	b_scrBuffer=0;
	b_nReturn=0;
