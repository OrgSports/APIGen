...
CAG_EOLE_5250_NODE_VBS::CAG_EOLE_5250_NODE_VBS()
{
	resetVariableFlags();	
}
...
void CAG_EOLE_5250_NODE_VBS::generateHeader(CStringArray* pcsaHeader,
...
void CAG_EOLE_5250_NODE_VBS::appendBody(int nFunctionNum,
...
void CAG_EOLE_5250_NODE_VBS::finalize(CStringArray* pcsaBody)
{
	pcsaBody->Add("");
...
void CAG_EOLE_5250_NODE_VBS::declareVariable(AG_VARIABLE agVariable,
											 CStringArray* pcsaHeader,
											 bool* bValue)
{
	CString csLocal;
...
void CAG_EOLE_5250_NODE_VBS::checkDebug(bool b_Debug,
...
void CAG_EOLE_5250_NODE_VBS::resetVariableFlags()
{
	b_cString=FALSE;
	b_Area=FALSE;
	b_bRet=FALSE;
