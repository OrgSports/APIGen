...
void CAG_IHL_CS::declareVariable(AG_VARIABLE agVariable,
...
void CAG_IHL_CS::generateHeader(CStringArray* pcsaHeader,
...
void CAG_IHL_CS::appendBody(int nFunctionNum,
...
void CAG_IHL_CS::finalize(CStringArray* pcsaBody)
{
		CString csLocal;
...
void CAG_IHL_CS::checkDebug(bool b_Debug,
...
void CAG_IHL_CS::resetVariableFlags()
{
