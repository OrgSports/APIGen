...
CAG_AIR_VM_T27_J::CAG_AIR_VM_T27_J()
{
	resetVariableFlags();
}
...
void CAG_AIR_VM_T27_J::generateHeader(CStringArray* pcsaHeader,
...
void CAG_AIR_VM_T27_J::appendBody(int nFunctionNum,
...
void CAG_AIR_VM_T27_J::finalize(CStringArray* pcsaBody)
{
	pcsaBody->Add("}");
	pcsaBody->Add("</script>");
	pcsaBody->Add("</BODY>");
...
/****************************************************************************DC
	Function	:	CAG_AIR_VM_T27_J::declareVariable()

	Purpose		:	Append variable declarations to the end of the header as 
					needed.

*****************************************************************************/
void CAG_AIR_VM_T27_J::declareVariable(AG_VARIABLE agVariable,
									   CStringArray* pcsaHeader,
									   bool* bValue)
{
	CString csLocal;
...
void CAG_AIR_VM_T27_J::checkDebug(bool b_Debug,
								  CString csFunctionName,
								  CStringArray* pcsaBody)
{
	CString csLocal;
...
void CAG_AIR_VM_T27_J::resetVariableFlags()
{
